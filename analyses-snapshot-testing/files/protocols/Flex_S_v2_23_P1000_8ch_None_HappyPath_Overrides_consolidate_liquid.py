...
def run(ctx):
    ...
    pipette_8ch_1000.consolidate_liquid(
        ...
        volume=volume,
        source=[source.wells_by_name()[well] for well in WATER_SOURCE_WELLS],
    ...
    pipette_8ch_1000.consolidate_liquid(
        ...
        volume=volume,
        source=[source.wells_by_name()[well] for well in ETHANOL_SOURCE_WELLS],
    ...
    pipette_8ch_1000.consolidate_liquid(
        ...
        volume=volume,
        source=[source.wells_by_name()[well] for well in GLYCEROL_SOURCE_WELLS],
