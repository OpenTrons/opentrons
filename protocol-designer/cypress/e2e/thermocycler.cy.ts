...
import { ThermocylerEditor, ThermoProfile, ThermoProfileSteps, ThermoState, thermoVerifications } from '../support/Thermocycler'
...
describe('Redesigned Thermocycler Set Up Steps - Happy Path', () => {
  ...
  it('It should verify the working function of thermocycler set up', () => {
    ...
    steps.add(ThermoProfileSteps.AddCycle())
    steps.add(ThermoProfileSteps.CreateStep('cycleStep', 0, 'cycle test 1', '50', '05:00', '3'))
    steps.add(ThermoProfileSteps.AddCycleStep())
    steps.add(ThermoProfileSteps.CreateStep('cycleStep', 1, 'cycle test 2', '45', '05:55'))
    steps.add(ThermoProfileSteps.AddCycleStep())
    steps.add(ThermoProfileSteps.DeleteCycleStep(2))
    steps.add(ThermoProfileSteps.AddCycleStep())
    steps.add(ThermoProfileSteps.CreateStep('cycleStep', 2, 'cycle test 3', '35', '03:33'))
    steps.add(ThermoProfileSteps.SaveCycleOrStep())
    steps.add(ThermoProfileSteps.AddStep())
    steps.add(ThermoProfileSteps.CreateStep('addStep', NaN, 'add test 1', '35', '03:33'))
    steps.add(ThermoProfileSteps.DeleteCycleOrStep())
    steps.add(ThermoProfileSteps.AddStep())
    steps.add(ThermoProfileSteps.CreateStep('addStep', NaN, 'add test 2', '35', '03:33'))
    steps.add(ThermoProfileSteps.SaveCycleOrStep())
    steps.add(ThermoProfileSteps.AddStep())
    steps.add(ThermoProfileSteps.CreateStep('addStep', NaN, 'add test 3', '35', '03:33'))
    steps.add(ThermoProfileSteps.SaveCycleOrStep())
